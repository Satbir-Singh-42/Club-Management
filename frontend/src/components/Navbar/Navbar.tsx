      ...
      <div className={`"container mx-auto px-4 ${isOpen?"pb-4":"pb-0"}`}>
        <div className="flex justify-between items-center py-4">
          ...
          <div className="flex gap-1">
            ...
            >
              ...
              {loginStatus && 
              <button className="bg-blue-500 text-white px-4 py-2.5 rounded-md hover:bg-blue-600 hidden lg:block"
                onClick={()=>onLogout()}
              >
                Logout
              </button>
              ...
              <button className="text-[rgb(2,7,138)] border border-gray-200 px-6 py-2 rounded-md hover:bg-blue-100 hidden lg:block shadow-md"
        ...
        {isOpen && (
          <div className="lg:hidden bg-white shadow-md mt-2 rounded-lg">
            {/* Updated mobile Clubs & Societies link */}
            <Link
              to="/clubpage" // Use the correct path for the ClubPage
