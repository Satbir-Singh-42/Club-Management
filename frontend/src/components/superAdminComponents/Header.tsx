...
import { UploadPhoto } from "@/components/superAdminComponents/UploadPhoto"

export function Header() {
  // State to control the visibility of the profile photo upload modal
  ...
  <DropdownMenuTrigger asChild>
    ...
    <Avatar className="w-10 h-10"> {/* Adjust size here */}
